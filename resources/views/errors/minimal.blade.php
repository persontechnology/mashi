    ...
    <div class="container">
        ...
        <div class="row align-items-center text-center py-sm-5">
            ...
            <div class="col-lg-8 mx-auto">
                    ...
                    <svg class="col-sm-7 col-lg-5" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                      ...
                      C1041.5,672.8,1103.1,678.7,1103.1,685.3z" />
                                    <g>
                                        ...
                                        <path style="fill:url(#SVGID_00000017490826837838658910000002142626527740690084_);"
                                            d="M484,594.6
                        ...
                        c9.5-15.1,21.5-28.8,33.8-35.4c2.6-1.4,5.3-2.5,7.9-3.2l10.5,36.2L309.1,702.8z" />
                                        ...
                                        <path style="fill:url(#SVGID_00000034068006629406653660000012692420182534256547_);"
                        ...
                        C571.5,677,576.3,692.2,579.3,707.5z" />
                                        ...
                                        <path style="fill:url(#SVGID_00000101803975007610050020000011470946412395280313_);"
                                            d="M957.4,701.2
                        ...
                        c21.4,16.7,39.7,45.4,53.1,73C948.9,680.1,953.6,691.2,957.4,701.2z" />
                                        ...
                                        <path style="fill:url(#SVGID_00000030466211624571626890000017464207134027537062_);"
                ...
                <!-- SVG END -->
                <!-- 404 info -->
                <h1 class="display-1 mt-4">@yield('code')</h1>
                <h2 class="mb-2 h1">@yield('message')</h2>
                <!-- Button -->
                <a class="btn btn-primary-soft btn-sm" href="{{ route('dashboard') }}">Inicio</a>
            </div>
            <!-- Error 404 START -->
        </div>
        <!-- Extra space -->
