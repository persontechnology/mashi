    ...
    // END: Video player
		...
		darkMode: function () {
			...
			var changeThemeToDark = () => {
				...
				if(dir == 'rtl') {
						style.setAttribute('href', '../../../ui/assets/css/style-dark-rtl.css');
				} else {
						style.setAttribute('href', '../../../ui/assets/css/style-dark.css');
				}
			...
			var changeThemeToLight = () => {
				...
				if(dir == 'rtl') {
						style.setAttribute('href', '../../../ui/assets/css/style-rtl.css');
				} else {
						style.setAttribute('href', '../../../ui/assets/css/style.css');
				}
	...
	avatarImg: function () {
		if (e.isVariableDefined(e.select('#avatarUpload'))) {
			...
			avtReset.addEventListener("click", function(){
				avtPreview.src = "../../../ui/assets/images/avatar/placeholder.jpg";
			});
		}			
	},
	// END: Avatar Image
