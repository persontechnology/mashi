        ...
        if ( loan_info!==0 ) {
            ...
            for ( var i=0; i<loan_info.num_payments; i++) { 
                ...
                output_content = output_content+ 
                    ...
                    '<'+cell_tag+' class="accrue-payment-amount">'+monto_f+'</'+cell_tag+'>'+
                    '<'+cell_tag+' class="accrue-total-interest"><input type="hidden" value="'+interest_f+'"/>'+interest_f+'</'+cell_tag+'>'+
                    '<'+cell_tag+' class="accrue-total-payments"><input type="hidden" value="'+pagos_f+'"/>'+pagos_f+'</'+cell_tag+'>'+
                    '<'+cell_tag+' class="accrue-balance"><input type="hidden" value="'+balance_f+'"/>'+balance_f+'</'+cell_tag+'>'+
                    '</tr>';
            }
